...
function ResetPasswordPageContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.password.length < 8) {
      setError("Contraseña debe ser por lo menos 8 caracteres de largo");
      setIsSubmitting(false);
      return;
    }
    ...
    try {
      console.log("🚀 ResetPasswordPage.handleSubmit: ");
      ...
      if (response.ok) {
        ...
        if (data.ok) {
          console.log('✅ 密码重置成功');
          setSuccess("¡Reinicializar con éxito! Ahora está conectado.");
          // 重定向到首页
          setTimeout(() => {
            router.push('/es');
          }, 2000);
        ...
        setError(errorData.error || "No ha podido restablecer la contraseña. Por favor, inténtelo de nuevo.");
      }
    } catch (error) {
      console.error("💥 ResetPasswordPage.handleSubmit: П异 Combinación", error);
        ...
        <div className="reset-container">
          <div className="reset-card">
            <div className="reset-form">
              <p className="reset-info">Cargando...</p>
            </div>
          </div>
        </div>
      </div>;
  ...
  return <div className="reset-page">
      <div className="reset-container">
        ...
        <header className="reset-header">
          <h1 className="reset-title">Reinicia tu contraseña</h1>
          <p className="reset-subtitle">Introduzca una nueva contraseña para su cuenta</p>
        </header>
            ...
            <form onSubmit={handleSubmit} className="reset-form">
              ...
              <div className="form-field">
                ...
                <div className="form-input-container">
                  <input id="password" type={showPassword ? "text" : "password"} required value={formData.password} onChange={e => handleInputChange('password', e.target.value)} className="form-input form-input-with-icon" placeholder="Introduzca su nueva contraseña" disabled={isSubmitting} autoComplete="new-password" minLength={8} />
              ...
              <div className="form-field">
                ...
                <div className="form-input-container">
                  <input id="confirmPassword" type={showConfirmPassword ? "text" : "password"} required value={formData.confirmPassword} onChange={e => handleInputChange('confirmPassword', e.target.value)} className="form-input form-input-with-icon" placeholder="Confirme su nueva contraseña" disabled={isSubmitting} autoComplete="new-password" minLength={8} />
              ...
              {error && <div className="form-message form-message-error">
                  <div className="form-message-content">
                    ...
                    <div>
                      <div className="form-message-title">Reiniciar falló</div>
...
export default function ResetPasswordPage() {
  return <Suspense fallback={<div className="reset-page">
        <div className="reset-container">
          <div className="reset-card">
            <div className="reset-form">
              <p className="reset-info">Cargando...</p>
